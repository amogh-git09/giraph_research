...
giraph build/libs/*.jar neural_net.BackwardPropagation -vip src/main/resources/6 -vif neural_net.NeuralNetworkVertexInputFormat -mc neural_net.NumberOfClasses -w 1 -ca giraph.SplitMasterWorker=false,giraph.logLevel=error
...
#$HADOOP_HOME/bin/hadoop jar build/libs/*.jar neural_net.BackwardPropagation -vip /user/hduser/input/graph.txt -vif neural_net.NeuralNetworkVertexInputFormat -mc neural_net.NumberOfClasses -w 1
