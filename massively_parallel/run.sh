...
giraph build/libs/*.jar neural_net.BackwardPropagation -vip src/main/resources/6 -vif neural_net.NeuralNetworkVertexInputFormat -mc neural_net.NumberOfClasses -w 1 -ca giraph.SplitMasterWorker=false,giraph.logLevel=error,giraph.workerContextClass=neural_net.PerformanceContext
